		...
		<view class="tp-box tp-box-sizing tp-flex tp-flex-col">
			...
			<uni-popup ref="addtrigPopup" type="bottom" :mask="true" :maskClick="true">
				<view class="logInfo">
					...
					<view class="info_btn">
						<view class="btn_del" @click="$refs.addtrigPopup.close()">{{$t('pages.addControl.cancel')}}</view>
			...
			<uni-popup ref="addConPopup" type="bottom" :mask="true" :maskClick="true">
				<view class="logInfo">
					...
					<view class="info_btn">
						<view class="btn_del" @click="$refs.addConPopup.close()">{{$t('pages.addControl.cancel')}}</view>
